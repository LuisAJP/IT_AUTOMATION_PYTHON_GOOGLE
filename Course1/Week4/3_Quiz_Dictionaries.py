...
# so that existing entries are replaced and new entries are added. What is the content 
...
# -(Correct)It’s quicker and easier to find a specific element in a dictionary
# (Explication) Right on! Because of their unordered nature and use of key value pairs, 
# searching a dictionary takes the same amount of time no matter how many elements it contains
