...
# 2) 
# Creating new instances of class objects can be a great way to keep 
# track of values using attributes associated with the object. 
...
# using objects to represent people. Fill in the blanks to make the code satisfy 
...
#  Fill in the blanks of the max_elevation_city function to return the name of the city and 
#  its country (separated by a comma), when comparing the 3 defined instances for a specified minimal population.
#   For example, calling the function for a minimum population of 1 million: max_elevation_city(1000000) 
...
# -An object is a specific instance of a class          (CORRECT)
